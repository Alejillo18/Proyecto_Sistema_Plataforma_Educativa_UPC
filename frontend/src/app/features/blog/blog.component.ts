  ...
  blogPosts = [
    {
      ...
      category: 'Novedad',
      categoryClass: 'cat-novedad',
      date: '10 Jun 2026',
      title: 'Nuevo diseño de la plataforma',
      excerpt:
        'Renovamos completamente la interfaz de UPC-Share con un diseño más moderno, oscuro por defecto y con mejor experiencia de usuario.',
      author: 'Equipo UPC-Share',
    },
    {
      icon: '<svg class="cat-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"></path></svg>',
      category: 'Tips',
      categoryClass: 'cat-tips',
      date: '5 Jun 2026',
      title: 'Cómo estudiar con apuntes digitales',
      excerpt:
        'Tips para aprovechar al máximo los recursos digitales: organización, técnicas de estudio y herramientas complementarias.',
      author: 'Rocío Casas',
    },
    {
      ...
      category: 'Comunidad',
      categoryClass: 'cat-comunidad',
      date: '1 Jun 2026',
      title: 'Estudiantes destacados de Mayo',
      excerpt:
        'Conocé a los estudiantes que más compartieron durante mayo. Gracias por construir esta comunidad.',
      author: 'Pablo González',
    },
    {
      icon: '<svg class="cat-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z"></path></svg>',
      category: 'Actualización',
      categoryClass: 'cat-actualizacion',
      date: '28 May 2026',
      title: 'Nuevo sistema de comentarios',
      excerpt:
        'Implementamos un sistema de comentarios mejorado con MongoDB para una experiencia más rápida y fluida.',
      author: 'Martín López',
    },
    {
      ...
      excerpt:
        'Ahora podés debatir y resolver dudas en foros dedicados por cada materia académica.',
    ...
    },
    {
      ...
      excerpt:
        'Guía para organizar tus materias, seguimiento de recursos y planificación de estudio.',
      author: 'Rocío Casas',
    },
  ];
}
